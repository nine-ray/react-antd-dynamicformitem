...
class DynamicFormItem extends React.Component {
  ...
  render() {
    const {keysName, getFieldDecorator, getFieldValue, extra, renderViewData, lable, renderView,addViewStyle,addView, ...other} = this.props;// 有默认传来的 chang事件，和 value值
    ...
    return (
      <Row>
        ...
        <FormItem {...formItemLayoutWithOutLabel}>
          <Button type="dashed" onClick={this.add} style={{width: '60%',...addViewStyle}}>
